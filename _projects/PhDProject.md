...
layout: page
title: 🐨
description: Creating Sonic Interactions through Musical Tension and Release (CadenceFlow)
img: assets/img/cadenceflow.jpg
importance: 1
category: PhD
---
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/overview.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
[***Click to see the detailed research process***](https://yorkcla.github.io/PhDFinalPT/)